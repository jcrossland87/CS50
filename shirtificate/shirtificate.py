# Week 8 Object-Oriented Programming Problem Set 8 Shirtificate shirtificate.py with shirtificate.png
#
# In a file called shirtificate.py, implement a program that prompts the user for their name and outputs,
# using fpdf2, a CS50 shirtificate in a file called shirtificate.pdf similar to this one for
# John Harvard, with these specifications:
...
# Hints
# Note that fpdf2 comes with a class called FPDF, which has quite a few methods, per py-pdf.github.io/fpdf2/fpdf/#fpdf.FPDF.
...
# Note that you can disable automatic page breaks, which might otherwise cause your PDF to overflow from one page to two,
# with set_auto_page_break, per py-pdf.github.io/fpdf2/Margins.html.
...
# Run your program with shirtificate.py. Make sure your program prompts you for a name. Enter your own name and press Enter.
# Your program should create a file, shirtificate.pdf, containing the name you entered as input overlaid on a rendering of
# shirtificate.png.
#
