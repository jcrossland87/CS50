# Week 3 Problem Set 3 Felipe’s Taqueria taqueria.py
...
# Hints Note that you can detect when the user has inputted control-d by catching an EOFError with code like:
# try:
#     item = input()
# except EOFError:
#     ...
...
# Run your program with python taqueria.py. Type Taco and press Enter, then type Taco again and press Enter. Your program should output: Total: $6.00
# and continue prompting the user until they input control-d.
# Run your program with python taqueria.py. Type Baja Taco and press Enter, then type Tortilla Salad and press enter. Your program should output: Total: $12.25
# and continue prompting the user until they input control-d.
