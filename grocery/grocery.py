# Week 3 Problem Set 3 Grocery List grocery.py
...
while True:
    try:
        ...
        if item in grocery:
            # If it is in the dictionary then add 1 to the count
            grocery [item] += 1
        # Otherwise add the item to the dictionary for the first time
        else:
            grocery[item] = 1
    except EOFError:
