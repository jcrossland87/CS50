# Week 4 Problem Set 4 Emojize emojize.py
...
# Hints Note that the emoji module comes with two functions, per pypi.org/project/emoji, one of which is emojize,
...
# import emoji after run 'pip install emoji' in terminal first to be installed to then import it

import emoji

user_answer = input("Input: ").strip()
